...
Architektur aus Tabelle \ref{table:stable-experiment} am stabilsten
herausstellte. Trotz des stabilen Trainings weisen die Ausgaben des
...
\section{Architektur von MotionGAN}