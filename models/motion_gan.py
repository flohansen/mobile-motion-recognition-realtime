...
def gradient_penality(critic, fake_sample, real_sample):
    ...
    with tf.GradientTape() as tape_gp:
        ...
        inter_score = critic(inter_sample)
...
class Generator():
  def __init__(self, classes, embedding_dim):
    ...
    self.conv2 = tf.keras.layers.Conv2DTranspose(64, 3, strides=2, padding='valid', use_bias=True)
